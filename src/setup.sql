  ...
  BEGIN
    ...
    select ltrim("generated_text") into watsonx_response
      from json_table(QSYS2.HTTP_POST(
       ...
       json_object('model_id': 'meta-llama/llama-2-13b-chat', 'input': text, 'parameters': json_object('max_new_tokens': 100, 'time_limit': 1000), 'space_id': coolstuff.spaceid), --TODO: add parameter for foundation model
       json_object('headers': json_object('Authorization': 'Bearer eyJraWQiOiIyMDI0MDcwNDA4NDAiLCJhbGciOiJSUzI1NiJ9..jyPTp8gCrv5B8DXkgHzNjrbPhw47UWccBqu0NANB351onUgf-c52Pninv8G299-kZxNcQFyIiYK1JMyb3Q0PMQ-2aHZMfOu6B8IqZ-iFbeUFJLoXnvZo2CYyAuffkd4Htu9RJg4DAzkSHVIx5Ns8Ile04x883XKdfA_kwvsmhSKY9HH7Asn4P4d-JJQtCHdnJm6GAZQmlficEbevhdTAxWxj-kgyt2941sM9buGKFlB1_zrIydjcvJhl-xk7NrG86iMVX2VYa-tqkf4J9veQhKSjFAXGXgSB6xdpOhMjs8-Ms7P827x0ZtUzXRzvBa0q8SBUEf8dZUKouv-0LcfBGA', 'Content-Type': 'application/json', 'Accept': 'application/json')) -- TODO: change this to reference the actual token
      ), 'lax $.results[*]'
      columns(
